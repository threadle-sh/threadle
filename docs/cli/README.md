...
Portable install (bundled Node 26 + app) into `~/.local/share/threadle` — no npm. Pin a version with `THREADLE_VERSION=1.0.2`. The installer verifies SHA-256 against the release `SHA256SUMS` file.
