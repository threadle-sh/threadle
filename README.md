...
Pin a curl release with `THREADLE_VERSION=1.0.0`. Uninstall as cleanly as you installed: `rm -rf ~/.local/share/threadle ~/.local/bin/threadle`. Everything threadle wrote lives in `~/.config/threadle`. [Install notes](docs/install.md) · [provider freshness](docs/provider-freshness.md)
